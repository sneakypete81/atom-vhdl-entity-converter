...
export default {
  ...
  selectAndParseEntity() {
    editor = atom.workspace.getActivePaneItem()
    entityRange = this.getScopeRange(editor, "meta.block.entity.vhdl")
    if (!entityRange) {
      return null;
    }
    ...
    entity = new Parser(editor.getTextInBufferRange(entityRange))
